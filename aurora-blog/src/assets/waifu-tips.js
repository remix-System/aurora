...
// 其他杂项设置
live2d_settings['l2dVersion']           = '114514';        // 当前版本
live2d_settings['l2dVerDate']           = '2023.7.12'; // 版本更新日期
live2d_settings['homePageUrl']          = 'https://plusx.xinchen.xyz';       // 主页地址，可选 'auto'(自动), '{URL 网址}'
live2d_settings['GPTPageUrl']          = 'https://plusx.xinchen.xyz/sparkgpt';
live2d_settings['aboutPageUrl']         = 'https://plusx.xinchen.xyz/about';   // 关于页地址, '{URL 网址}'
live2d_settings['screenshotCaptureName']= 'Xinchenlive2d.png'; // 看板娘截图文件名，例如 'live2d.png'
...
const  initModel = function initModel(waifuPath, type) {
  ...
  $('.waifu-tool .fui-chatgpt').click(function (){
    //跳转chatgpt
    window.open(live2d_settings.GPTPageUrl);
  });
  ...
  if (!live2d_settings.canTurnToHomePage) $('.waifu-tool .fui-chatgpt').hide();
